...
using Nexawo.Infrastructure.Files;
using Nexawo.Application.Common.Interfaces.DynamicObjects;
using Nexawo.Infrastructure.DynamicObjects;
...
namespace Nexawo.Infrastructure
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration, IWebHostEnvironment environment)
        {
            ...
            services.AddTransient<IDynamicModelService, DynamicModelService>();
            services.AddTransient<IDynamicControllerService, DynamicControllerService>();
            services.AddTransient<IDynamicViewService, DynamicViewService>();
